...
// Module
___CSS_LOADER_EXPORT___.push([module.id, `.homepage .content-1 {
  position: relative;
  display: flex;
  flex-direction: column;
  align-items: center;
  padding: 12.9rem 0 12.7rem 0;
  width: 100rem;
  box-sizing: border-box;
}`, "",{"version":3,"sources":["webpack://./src/style.css"],"names":[],"mappings":"AAAA;EACE,kBAAkB;EAClB,aAAa;EACb,sBAAsB;EACtB,mBAAmB;EACnB,4BAA4B;EAC5B,aAAa;EACb,sBAAsB;AACxB","sourcesContent":[".homepage .content-1 {\n  position: relative;\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  padding: 12.9rem 0 12.7rem 0;\n  width: 100rem;\n  box-sizing: border-box;\n}"],"sourceRoot":""}]);
// Exports
